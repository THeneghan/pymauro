...
def versioned_folder_json(label, return_dict=False):
...
def data_asset_json(folder_id, label, type='Data Asset', classifiers=None,
                     description=None, author=None, organisation=None, return_dict=False):
...
def data_class_json(label, domainType="DataClass", classifiers=None, metadata=None,
                        minMultiplicity=None, maxMultiplicity=None, return_dict=False):
    if classifiers is None:
        classifiers = []
    if metadata is None:
        metadata = []
...
def data_type_json(label, domainType="PrimitiveType", description=None, organisation=None,
                       ...
                       modelResourceDomainType=None, enumerationValues=None, modelResourceId=None, return_dict=False):
...
def add_profile_to_data_element_json(data_element_id, data_element_label, return_dict=False):
    dict_form = {'sections':
